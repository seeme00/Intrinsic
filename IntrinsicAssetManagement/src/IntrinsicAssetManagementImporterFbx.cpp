...
{
FbxManager* ImporterFbx::_fbxManager = nullptr;
...
void ImporterFbx::importMeshesFromNode(FbxNode* p_Node)
{
  _INTR_ASSERT(p_Node);
...
void ImporterFbx::importMesh(FbxMesh* p_Mesh)
{
...
void ImporterFbx::stripDuplicateVertices(Dod::Ref p_MeshRef)
{
